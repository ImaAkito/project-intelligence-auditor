...
def run(root: Path | str, collectors: list[tuple[str, Collector]] | None = None) -> dict[str, Any]:
    root_path = resolve_root(root)
    selected = import_default_collectors() if collectors is None else collectors
